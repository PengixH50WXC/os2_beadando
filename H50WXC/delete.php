...
echo "<form action ='delete_bonsai.php' method = 'post'>Bonsai törlése <input type='text' name='torles' placeholder='Bonsai neve' required><input type='submit' name='kuldes' value='Küldés'></form>";
echo "<hr>";
